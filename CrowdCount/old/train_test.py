            ...
            if not replay.can_sample():
                ...
                while rest>0:  
                    ...
                    if rest < parameters['TRAIN_SKIP']: 
                        ...
                        #TODO - Possibly might need to include case where Done is true. Its in SAC pseudo code.
                        
                        #TODO - Figure out how useful this update field is, look into it via video.
                        for update in range(UPDATES):
                            net.train()     
                            state_fv_batch, state_hv_batch, act_batch, rew_batch, next_state_hv_batch, done_mask = replay.out()
                            
                            #TODO - Compute Targets for the Q networks###################
                            
                            #############################################################
                            #TODO - Figure out what the fv and hv notation means, determine how it can be used.
                            ...
                            target_Q = newQ
                            #target_Q = newQ * parameters['GAMMA'] * (1 - done_mask) + rew_batch #Old
                            ...
                            #NOTE - This is updating using SGD, dont know if its updating policy using ascent but we shall see
                            optimizer.zero_grad()
                            loss.backward()
                            optimizer.step()  
